...
useEffect(()=>{
  ...
  return (
    <menu className='date-appointment 
      ...
      bg-white  w-[95%] h-[180px] rounded-[20px] border-blue-500 border-b-2 mt-7'>
      ...
      {/*consultant name and -- */}
       <div className='consultant-name flex justify-between items-center flex-row gap-40 mt-2 p-2'>
        ...
        <div className='name-occupation flex justify-start flex-col gap-1 pl-2'>
          ...
          <h3 className='occupation font-semibold  text-yellow-400'>{consultants[consultantname]}</h3>
        </div>
        </div>
        <div className='send-rqs  w-[350px]  flex justify-center items-center flex-row gap-4 mt-5 mr-6 '>
